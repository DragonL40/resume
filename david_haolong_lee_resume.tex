...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\href{http://sourabhbajaj.com/}{\Large David Haolong Lee}} & Email : \href{mailto:davidhlee2001@gmail.com}{davidhlee2001@gmail.com}\\
  \href{http://sourabhbajaj.com/}{http://www.sourabhbajaj.com} & Mobile : (+86)136-5988-8654 \\
\end{tabular*}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Researcher}{June 2018 - August 2018}
      \resumeItemListStart
        \resumeItem{"A Uniform Parcel Delivery System Based on IoT"}
          {Researched on the Internet of Things and its application in parcel delivery systems. Paper published on \textit{Advances in Internet of Things}}
      \resumeItemListEnd
...
%-------------------------------------------
    ...
    \resumeSubheading
      {High School VEX Robotics Team}{Mountain View, CA}
